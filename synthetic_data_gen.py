# This code is being used from Negar Hassanpour and Russell Greiner. Learning disentangled representations for counterfactual regression. In ICLR, 2019.
# we used this code to generate synthetic data and did no modification in the code
import numpy as np
...
if __name__ == "__main__":
	...
	n_trn = 1000	# int(sys.argv[]) 15000
	n_tst = 300	# int(sys.argv[]) 5000
	n = n_trn+n_tst
